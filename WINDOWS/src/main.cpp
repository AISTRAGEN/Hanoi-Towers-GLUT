...
// вказівник на клас Scene
Scene* scene; 

// Викликаємо відповідні функцію класу Scene:
void on_paint()
{
    scene->on_paint();
}
...
int main(int argc, char* argv[])
{
    ...
    scene = new Scene(0.4);   // створюємо об'єкт "сцена"
    ...
    glutCreateWindow("Tower of hanoi");     // створюємо вікно
